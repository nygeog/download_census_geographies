...
download_location = 'INSERT YOUR FOLDER LOCATION'
#EXAMPLE for Mac 
download_location = '/Volumes/Echo/GIS/data/census/2000/tracts/'
...
for i in state_fips:
	url = 'http://www2.census.gov/geo/tiger/TIGER2010/TRACT/2000/tl_2010_'+i+'_tract00.zip'
	outzip = download_location + 'tl_2010_'+i+'_tract00.zip'
	print 'downloading... ' + url
	urllib.urlretrieve(url, outzip)
	print 'unzipping... ' + outzip
	zipfile.ZipFile(outzip).extractall(download_location)
	os.remove(outzip)
	print "Deleting... " + outzip + "'s ZIP file"
